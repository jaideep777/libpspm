...
legend(x = 80, y=320, legend = names, col=cols_m, lwd=2, bty = "n", cex=1.3)
...
cols_m1 = cols_m[-c(3,length(cols_m))]
names1 = names[-c(3,length(cols_m))]
...
legend(x = 160, y=275, legend = c("IFMU", "IEBT"), col=cols_m1, lwd=2, bty = "n", cex=1.3)
